...
public class MailRuLoginTest {
    ...
    public void mailRuLoginTest() throws InterruptedException{
        System.setProperty("webdriver.chrome.driver", "C:\\Users\\Home\\Desktop\\10labweb\\drivers\\chromedriver-win64");
        ...
        driver.findElement(By.xpath("//*[@class='input-0-2-71']")).sendKeys("testfed131");
        driver.findElement(By.xpath("//*[@class='base-0-2-79 primary-0-2-93']")).click();
        Thread.sleep(Duration.ofSeconds(2).toMillis());

        // Вводим пароль и нажимаем на кнопку войти
        driver.findElement(By.xpath("//*[@class='input-0-2-71 withIcon-0-2-72']")).sendKeys("vSr-6vB-eja-4eU");
        ...
        Assert.assertEquals("Nastya Fed",driver.findElement(By.xpath("//*[@class='ph-name svelte-1popff4']")).getText());
